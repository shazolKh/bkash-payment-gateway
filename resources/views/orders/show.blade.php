    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <h6 class="card-title">Name: {{ $order->product_name }}</h6>
                    <p class="card-text amount" style="color: red">Price: {{ $order->amount }} BDT</p>
                    <p class="card-text invoice">Invoice: {{ $order->invoice }}</p>
                    @if($order->status == 'Pending')
                        <button class="btn btn-primary">Pay with bKash</button>
